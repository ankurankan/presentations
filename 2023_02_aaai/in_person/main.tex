...
\begin{frame}
	...
	\begin{enumerate}
		\setlength\itemsep{1em}
		\item Stratification based tests: Converts CI tests into a
		...
		\item Variable Importance based tests: Uses two probability estimators $ \hat{p}(x | y, z) $ and $ \hat{p}(x | z) $ to compare the goodness of fit.
		\item Residulaization based tests: Uses two estimators $
...
\begin{frame}
	...
	\begin{figure}
		\begin{subfigure}{0.7\textwidth}
				...
				\caption*{Sample sizes (top to bottom): $ [20,
					  40, 80] $. No. of conditional variables (left
					  to right): $ [1, 3, 5] $}
		\end{subfigure}%
