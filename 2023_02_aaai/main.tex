...
\begin{frame}
	...
	\todo[inline]{Finish this example}
	\[
		\begin{array}{ccc}
			Y & \hat{p}(y) & R_y \\
...
\begin{frame}{Empirical Analysis}
	\begin{itemize}
		\item Use the proposed test with two estimators Random Forest (RFT) and Generalized Linear Models (GLM).
		\item Even though RF is not an M-Estimator, we use it as a sensitivity analysis for
			how well the test works with non M-Estimators.
