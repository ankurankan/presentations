	...
	\begin{columns}
		\begin{column}{0.5 \textwidth}
			\begin{itemize}
				...
				\item Providing context in such cases can result in getting the correct answer. \todo[inline]{Add the example here}
			\end{itemize}
		\end{column}
		\begin{column}{0.5 \textwidth}
			\begin{figure}
			...
			\end{figure}
		\end{column}
	\todo[inline]{Change this figure to without the caption}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\end{figure}
	\todo[inline]{Keep only a few lines}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[scale=0.2]{imgs/table_11_12.png}
	\end{figure}
\end{frame}
