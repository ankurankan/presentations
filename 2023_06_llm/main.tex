...
\begin{frame}
	\frametitle{Understanding LLM output}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{figure}
...
\begin{frame}
	...
	\todo[inline]{Cut down few of the later slides}
	\begin{itemize}
