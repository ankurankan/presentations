...
\begin{tikzpicture}
	\node[measure] (x) at (6, 0) {Drowning Cases};
	\node[measure] (y) at (0, 0) {Ice-cream Sales};
	\node[latent] (u) at (3, 1) {Season};
...
\begin{tikzpicture}
	...
	\node[latent] (y) at (3, 0) {Blood Pressure};
	\node[measure] (z) at (6.5, 0) {Heart Disease};
...
\begin{tikzpicture}
	\node[measure] (x) at (0, 0) {Exercise Freq};
	\node[latent] (y) at (3, -1) {Heart Disease};
	\node[measure] (z) at (6, 0) {Diet Quality};
