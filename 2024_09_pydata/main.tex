...
\begin{frame}{Predictive vs Causal Modelling}
	...
	\textbf{Causal Modelling}
		\begin{itemize}
			\item Usually interested in identifying potential interventions and their effects.
...
\begin{frame}{Causal Discovery: Automated Algorithms}
	\begin{itemize}
		...
		\item As causal discovery is an unsupervised learning problem, difficult to decide/choose between different outputs.
	\end{itemize}
\end{frame}
...
\begin{frame}{Model Evaluation}
	\begin{figure}
		...
		\tikzstyle{every node}=[align=left]
			...
			\node (estimation) at (12, -2.5) {Effect Estimate};
