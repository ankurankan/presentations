...
\begin{frame}{Predictive vs Causal Modelling}
	...
	\textbf{Causal Modelling:}
		\begin{itemize}
			\item Interested in identifying potential interventions and their effects (answering what-if question).
...
\begin{frame}{Data Generating Process}
	...
	\begin{itemize}
		\item Confounder:  \begin{figure} \includegraphics[scale=0.8, page=3]{figures.pdf}\end{figure}
		\item Mediator: \begin{figure} \includegraphics[scale=0.8, page=8]{figures.pdf} \end{figure}
		\item Collider:
	\end{itemize}
...
\begin{frame}{Examples}
	\todo[inline]{Add another example}
\end{frame}
...
\begin{frame}{Causal Discovery: Expert-In-The-Loop}
	\begin{figure}
		...
		\begin{subfigure}{0.5 \textwidth}
			\centering
			\includegraphics[scale=0.28]{imgs/adult_llm.png}
		\end{subfigure}
	\end{figure}
