...
\begin{frame}
	...
	\begin{figure}
		...
		\caption*{An example Directed Acyclic Graph (DAG) \footnotemark}
	\end{figure}
	\begin{itemize}
	...
	\end{itemize}
	\footnotetext[1]{\footnotesize{K. B. Korb, A. E. Nicholson. Bayesian Artificial Intelligence, 2nd edition, Section 2.2.2. CRC Press, 2010.}}
\end{frame}
...
\begin{frame}
	...
	\end{itemize}
	\todo[inline]{Add an example of model testing}
...
\begin{frame}
	...
	\end{itemize}
	\todo[inline]{Add a figure showing structure learning example here}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		...
		\caption*{Example of structure learning using MI test on US census income dataset}
	\end{figure}
	\begin{itemize}
		\item Compared to normal independence testing Conditional
			independence testing is much harder.
	...
	\footnotetext[2]{\footnotesize{Shah, Rajen D., and Jonas Peters. "The hardness of conditional independence testing and the generalised covariance measure."}}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Any unbiased estimator can be used. We show empirical results using Random Forest and Logistic Regression.
...
\begin{frame}
	...
	\footnotetext[1]{\footnotesize C. Li and B. E. Shepherd. A new residual for ordinal outcomes}
\end{frame}
