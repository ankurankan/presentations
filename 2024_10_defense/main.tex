...
\begin{frame}{Causal Inference}
	...
	Does vaccination reduce the spread of infectious disease?
	}
	\only<3>{
	\todo[inline]{Insert figure here}
	Does exposure to violent video games increase aggressive behavior in children?
	}
	\only<4>{
	\todo[inline]{Insert figure here}
...
\begin{frame}{Causal Graphs}
	\center{To answer such questions from observational data, we need to understand the causal mechanism}
