...
\begin{frame}{Randomized Controlled Trials}
	...
	\only<2>{
		\begin{itemize}
			\item There is a causal relationship if there is a difference between the two groups.
			\item The difference can be use to quantify the effect of vaccination.
		\end{itemize}
	}
\end{frame}
