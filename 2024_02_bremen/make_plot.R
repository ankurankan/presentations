...
p_cal <- ggplot(calibration_df) +
	...
	scale_color_discrete(labels=c(arht="ARHT", pillai="Pillai-Bartlett Trace", q3=latex2exp::TeX("Hotelling's $T^2$"), chi2="Chi-Squared")) + 
...
# ggsave('conclusion/calibration.pdf', plot=p_cal, width=2.5, height=2, units='in')
...
# ggsave('conclusion/accuracy.pdf', plot=p_acc, width=2.5, height=2, units='in')
