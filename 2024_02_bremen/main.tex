...
\begin{frame}{Calibration: Data Generation}
	To generate conditionally independent datasets, the following DAG is used:
...
\begin{itemize}
	\item $ Z_2 \ldots Z_k $ are noise variables.
\end{itemize}
...
\begin{frame}{Calibration: Mixed Data}
	\begin{figure}[t]
		...
		\caption*{\footnotesize{Left to Right: Increasing number of conditional variables [2, 4, 8]. Top to Bottom: Increasing sample size: [40, 60, 80].}}
	\end{figure}
\end{frame}
...
\begin{frame}{Calibration: Discrete Data}
	\begin{figure}[t]
		...
		\caption*{\footnotesize{No of conditional variables fixed to $ 4 $. Left to Right: Increasing cardinality of categorical variables [4, 8, 12]. Top to Bottom: Increasing sample size: [40, 60, 80].}}
	\end{figure}
\end{frame}

\begin{frame}{Accuracy: Data Generation}
	We use the following DAG to generate datasets with varying effect between $ X $ and $ Y $.
