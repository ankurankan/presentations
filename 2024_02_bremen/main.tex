...
\begin{frame}{Path Coefficients for Continuous Variables}
	% Insert the adult income dataset here.
	\begin{itemize}
...
\begin{frame}{Extending this to mixed data}
	...
	\begin{itemize}
		\item We have a way to compute residuals in mixed data. % Add citation
		\item We need some effect size for these residuals. % Add citation
	\end{itemize}
\end{frame}
