...
\begin{frame}{Identification}
	...
	\end{figure}
	\begin{itemize}
		\item Once we have decided on the model, we can start estimating causal effects.
		\item \textbf{Identification}: Whether the causal effect is estimable? If yes, what is the estimand?
...
\begin{frame}{do-calculus}
	...
	\textcolor{red}{No efficient algorithms to use it in practice}

	Solution is to use simpler criteria for identifiability. But it can miss cases which might be identifiable.
\end{frame}
...
\begin{frame}{Estimation}
	...
	\begin{itemize}
		...
		\item Use your faviorite estimator to actually do the estimates.
	\end{itemize}
\end{frame}
