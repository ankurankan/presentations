...
\begin{frame}{Automated Algorithms}
	\begin{itemize}
		...
		\item With no standard evaluation method, difficult to choose a model.
	\end{itemize}
\end{frame}
...
\begin{frame}{Expert Knowledge Integration}
	\begin{itemize}
		\item Users can blacklist/whitelist edges.
	\end{itemize}
	\begin{figure}
		\centering
...
\begin{frame}{Expert Knowledge Integration}
	\begin{itemize}
		\item Hill-Climb Search does local optimization, giving a good start point can lead to better results.
	\end{itemize}
	\begin{figure}
		\centering
...
\begin{frame}{Expert Knowledge Integration}
	\begin{itemize}
		\item Can fix some edges that we are confident about to be present in the final DAG.
	\end{itemize}
	\begin{figure}
		\centering
