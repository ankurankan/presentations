...
\begin{frame}{Testing and Evaluation}
	...
	\begin{itemize}
		...
		\item Hard to distinguish between direct and indirect effects, hence common to end up with very dense models when drawing manually.
	\end{itemize}
\end{frame}
...
\begin{frame}{Correlation Score and Fisher's C}
	Correlation Score: F1-scores comparing pair of variables correlated in the data vs in the DAG.
	\begin{figure}
		\centering
...
\begin{frame}{Score metrics}
	\begin{itemize}
		\item Scores the network structure.
...
\begin{frame}{Future Plans}
	\begin{itemize}
		...
		\item Add more commonly used algorithms.
	\end{itemize}
\end{frame}
