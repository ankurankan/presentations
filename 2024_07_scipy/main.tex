...
\begin{frame}{Predictive vs Causal Modelling}
	\textbf{Predictive Modelling}
		\begin{itemize}
			...
			\item Interested in prediction accuracy.
		\end{itemize}
	\vspace{1em}
	\textbf{Causal Modelling}
		\begin{itemize}
			\item Tries to figure out causal relationship between variables.
			\item Interested in causal effect estimation or understanding the data generating mechanism.
...
\begin{frame}{Example: Protein Signalling Causal Network}
	\begin{columns}
...
\begin{frame}{Model Evaluation}
	\center{Don't have access to ground truth, so no straight-forward way to evaluate the models.}
...
\begin{frame}{Fisher's C}
	\center{Combines the CI tests to give a single p-value.}
	\vspace{2em}
	\begin{figure}
		\centering
