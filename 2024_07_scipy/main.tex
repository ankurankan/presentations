...
\begin{frame}{Causal Discovery}
	...
	\end{figure}
	\begin{itemize}
		\item \textbf{Casual Discovery: } Given a dataset, learn the causal structure among the variables.
		\item Challenging to come up with a correct model.
	\end{itemize}
\end{frame}
...
\begin{frame}{Automated Algorithms}
	...
	\vspace{3em}
	\begin{itemize}
		\item Algorithms have nice asymptotic properties.
		\item In practice however, results vary significantly depending on the 
			sample size, algorithm, and hyperparameters.
	\end{itemize}
\end{frame}
