...
\begin{frame}{Testing and Evaluation}
	...
	\begin{itemize}
		\item Adding expert knowledge can be helpful, but algorithms can still end up learning incorrect models.
	\end{itemize}
\end{frame}
...
\begin{frame}{Model Evaluation}
	...
	\begin{itemize}
		\item \textbf{Implied Conditional Independence (CI) Testing.}
		\item \textbf{Fisher's C:} Summarizes the CIs testing into a single p-value.
		\item \textbf{Correlation score:} F1-Score of how much of observed correlations in the data is explained by the model.
		\item \textbf{Data Fit metrics:} To compare the fit of two or more models to given data.
	\end{itemize}
\end{frame}
...
\begin{frame}{Fisher's C}
	\center{Combines the CI tests to give a single p-value. p-value $ > $ threshold signifies good fit.}
	\vspace{2em}
	\begin{figure}
		\centering
...
\begin{frame}{Correlation Score}
	\center{F1-scores comparing pair of variables correlated in the data vs in the DAG.}
	\vspace{2em}
	\begin{figure}
		\centering
...
\begin{frame}{do-calculus}
	...
	\begin{itemize}
		...
		\item i.e., can give an estimation strategy for every identified causal effect.
		\item However, no efficient algorithms for do-calculus.
...
\begin{frame}{Identification with pgmpy}
	\begin{figure}
		\centering
