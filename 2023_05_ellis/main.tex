...
\begin{frame}
	\frametitle{\titlecap{Residual for ordinal variables: LS-Residuals Example}}
	\todo[inline]{Change this example to the one I showed in the lecture}
...
\begin{frame}
	\frametitle{\titlecap{Residual for categorical variables: Using dummy encoding}}
...
\section{Test Performance: Empirical Anaylysis}
\begin{frame}
